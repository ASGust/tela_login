...
class Application():
    ...
    def tela_login(self):
        ...
        label = ctk.CTkLabel(master=login_frame, text="Login", font=("Roboto", 20)).place(x=25, y=5)
        ...
        def tela_register():
            ...
            label = ctk.CTkLabel(master=rg_frame, text="FASSE SEU CADASTRO", font=("Roboto", 20)).place(x=25, y=5)
